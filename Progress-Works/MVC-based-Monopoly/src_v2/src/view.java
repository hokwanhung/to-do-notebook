...
public class view extends javax.swing.JFrame {
	...
	public void udtOwner(int slotID, int playerID) {
		switch (playerID) {
		case 0:
			ownerJ[slotID].setForeground(Color.red);
			break;
		case 1:
			ownerJ[slotID].setForeground(Color.orange);
			break;
		case 2:
			ownerJ[slotID].setForeground(Color.green);
			break;
		case 3:
			ownerJ[slotID].setForeground(Color.blue);
			break;
		case 4:
			System.out.println("Reset land slot index: " + slotID);
			ownerJ[slotID].setForeground(Color.black);
			break;
		}
	}
	...
	public void udtNotice(String n) {
		...
		udtNoticeColor(turnLL.getText());
	}

	public void udtNoticeColor(String text) {
		switch (text) {
		case "PLAYER 1":
			turnLL.setForeground(Color.red);
			break;
		case "PLAYER 2":
			turnLL.setForeground(Color.orange);
			break;
		case "PLAYER 3":
			turnLL.setForeground(Color.green);
			break;
		case "PLAYER 4":
			turnLL.setForeground(Color.blue);
			break;
		}
	}
